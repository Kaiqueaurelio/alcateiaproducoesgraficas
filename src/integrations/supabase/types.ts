  ...
  public: {
    Tables: {
      ...
      briefing_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "briefing_links_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "briefing_links_quote_id_fkey"
            columns: ["quote_id"]
            isOneToOne: false
            referencedRelation: "quotes"
            referencedColumns: ["id"]
      ...
      client_briefings: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_briefings_link_id_fkey"
            columns: ["link_id"]
            isOneToOne: true
      ...
      briefing_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "briefing_files_link_id_fkey"
            columns: ["link_id"]
            isOneToOne: false
            referencedRelation: "briefing_links"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "briefing_files_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
      ...
      art_versions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "art_versions_link_id_fkey"
            columns: ["link_id"]
            isOneToOne: false
            referencedRelation: "briefing_links"
            referencedColumns: ["id"]
      ...
      art_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "art_comments_art_version_id_fkey"
            columns: ["art_version_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      is_valid_briefing_token: { Args: { _token: string }; Returns: boolean }
      get_public_briefing: {
        Args: { _token: string }
        Returns: Json
      }
      submit_public_briefing: {
        Args: { _token: string; _briefing: Json; _files: Json }
        Returns: Json
      }
      review_public_art: {
        Args: {
